...
BXH=(
  ...
  --source "Belle — Salvaged"
  --source-url "https://salvaged.nu/2022/03/24/brush-packs-from-bruisedxheartorg/"
  --license unknown
...
AT0=(
  ...
  --source "Belle — Salvaged"
  --source-url "https://salvaged.nu/2023/05/22/17x-brushes-from-at0mica-net/"
...
echo "done — $("$NODE" -e 'const m=require("./data/brushes.json");console.log(m.packs.length+" packs, "+m.brushes.length+" brushes")')"
