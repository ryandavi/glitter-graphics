...
class MaskEditor {
	...
	_getEraseBiteCanvas(layer) {
		...
		if (!this._biteCanvas) {
			this._biteCanvas = createAppCanvas(0, 0, 'systems/MaskEditor');
		}
	...
	_captureScratchCanvases(paint) {
		this.scratchAddCanvas = createAppCanvas(0, 0, 'systems/MaskEditor');
		...
		this.scratchSubCanvas = createAppCanvas(0, 0, 'systems/MaskEditor');
	...
	_crispRasterTip(shape, tip) {
		...
		if (this._crispTipKey !== key) {
			const crisp = createAppCanvas(0, 0, 'systems/MaskEditor');
	...
	_getOverlayStripePattern(color) {
		...
		const patternCanvas = createAppCanvas(0, 0, 'systems/MaskEditor');
