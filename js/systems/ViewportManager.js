...
class ViewportManager {
	...
	_syncPixelGrid() {
		// An animated view transition interpolates the wrapper transform in CSS,
		// which the overlay cannot follow; it reappears when the transition ends.
		this.pixelGrid.setVisible(this.currentZoom >= CONFIG.ui.zoom.pixelGridMinZoom
			&& PREFERENCES.get('pixelGrid')
			&& !this.previewWrapper.classList.contains('viewport-transition'));
	}
